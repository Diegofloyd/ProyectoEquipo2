        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <h2 class="mb-4" align="center">Alta de Alumno</h2>
            <div id="Menu2" >
                    <form method="POST" action="<?php echo base_url();?>/index.php/Home/Alumnos_Insert" role= "form"  >
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-3" id="campo">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="grupo" id="grupo" value="" >
                                </div>
                            </div>
                        </div>
